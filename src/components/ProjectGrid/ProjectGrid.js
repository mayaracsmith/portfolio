...
const projectGrid = () => (
    <div>
        <div className={classes.Cards}>
            ...
            <Nav.Link href="https://caldeirascakes.netlify.app/" target="_blank" rel="noopener noreferrer">Caldeira's Cakes</Nav.Link></div>
        ...
        <img src="/assets/img/burgerbuilder.png" alt="Burger Builder"/>
            ...
            <Nav.Link href="https://mayas-burger-builder.netlify.app/" target="_blank" rel="noopener noreferrer">Burger Builder</Nav.Link></div>
        </div>
        <div className={classes.Cards}>
            ...
            <Nav.Link href="https://gateway-portugal.netlify.app/" target="_blank" rel="noopener noreferrer">Gateway - Portugal</Nav.Link></div>
        ...
        <img src="/assets/img/hotel.png" alt="Hotel App"/>
            ...
            <Nav.Link href="https://hotelmcs.netlify.app/" target="_blank" rel="noopener noreferrer">Hotel MCS</Nav.Link></div>
        </div>
        <div className={classes.Cards}>
            ...
            <Nav.Link href="https://guessingapp.netlify.app/" target="_blank" rel="noopener noreferrer">Guessing Game</Nav.Link></div>
        ...
        <img src="/assets/img/navbar.png" alt="Animated NavBar"/>
            ...
            <Nav.Link href="https://interactive-navbar.netlify.app/" target="_blank" rel="noopener noreferrer">Animated Navbar</Nav.Link></div>
        </div>
        <div className={classes.Cards}>
            <div className={classes.Title}><h2>Pokemon Inquirer App</h2>
            <p>My first full-stack project. Created with React, Bootstrap, CSS modules and MySQL.</p>
            <Nav.Link href="#" target="_blank" rel="noopener noreferrer">Pokemon Inquirer</Nav.Link></div>
        ...
        <img src="/assets/img/cakes.png" alt="Weather App"/>
            ...
            <p>My first full-stack project. Created with React, Bootstrap, CSS modules and MySQL.</p>
            <Nav.Link href="#" target="_blank" rel="noopener noreferrer">Weather App</Nav.Link></div>
        </div>
        <div className={classes.Cards}>
            <div className={classes.Title}><h2>Github Page Locator App</h2>
            <p>My first full-stack project. Created with React, Bootstrap, CSS modules and MySQL.</p>
            <Nav.Link href="https://react-github-cards-maya.netlify.app/" target="_blank" rel="noopener noreferrer">Github Page Locator</Nav.Link></div>
        ...
        <img src="/assets/img/cakes.png" alt="To - Do List"/>
            ...
            <p>My first full-stack project. Created with React, Bootstrap, CSS modules and MySQL.</p>
            <Nav.Link href="#" target="_blank" rel="noopener noreferrer">To-Do List</Nav.Link></div>
        </div>
        <div className={classes.Cards}>
            <div className={classes.Title}><h2>Tic Tac Toe</h2>
            <p>Game created in class with my tech instructor. We used React and .....</p>
            <Nav.Link href="https://mayas-tic-tac-toe.netlify.app/" target="_blank" rel="noopener noreferrer">Tic Tac Toe</Nav.Link></div>
