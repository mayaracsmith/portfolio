...
const testimonial = () => (
    ...
    // <div className={classes.Testimonial2}><p>I’ve been amazed by Maya’s ability to quickly learn new languages and execute technical and polished websites. 
    ...
    //     tasks is refreshing and makes her a joy to work with. I am confident she would be an asset to any organization. She’s a reliable teammate with a strong work ethic to build on her craft.</p></div>
    ...
    // <div className={classes.Quotes}><i class="fas fa-quote-left"></i></div>
    // <div className={classes.Testimonial}><p>Maya is a curious, problem-solver who has consistently delivered quality work throughout the Road to Hire Fellowship program. 
    ...
    //      ‘can-do’ attitude. I know she will do well and be an asset to any team.</p></div>
